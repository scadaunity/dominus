    ...
    <form action="{{route('aluno.update',['aluno'=>$aluno])}}" method="post">
        ...
        <div class="row g-3">
            ...
            <div class="col-sm-2">
                ...
                <input type="text" class="form-control form-control-sm" id="nascimento" name="dataNascimento" placeholder="DD/MM/AAAA" value="{{$aluno->dataNascimento}}">
            </div>
            ...
            <div class="col-sm-1">
                ...
                <select class="form-select form-select-sm" id="estado" name="estado" value="{{ $aluno->estado }}">
